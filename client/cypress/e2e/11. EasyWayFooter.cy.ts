describe('EasyWay Footer Test', () => {
    ...
    it('has the About, Services, EasyWay and Social media sections with relevant links', () => {
      cy.get('footer')
      .children('.container')
      .children('.row')
      .children()
          ...
          .each(($el, index, $list) => {
            ...
            .each(($el, index, $list) => {
                  if (index === 0) {
                      cy.wrap($el)
                      .find('a')
                      .should('have.attr','href','https://github.com/ksharma67/EasyWay')
    ...
    it('has the Copyright statement', () => {
        ...
        .should('contain.text','Copyright EasyWay @ Fall 2022')
    });
